...
import 'package:gemini_chat_app/utility/utilites.dart';
import 'package:gemini_chat_app/widgets/preview_images_widget.dart';
...
class _BottomChatFieldState extends State<BottomChatField> {
  ...
  void pickImage() async {
    try {
      final pickImages = await _picker.pickMultiImage(
          maxHeight: 800, maxWidth: 800, imageQuality: 95);
      widget.chatProvider.setImagesFileList(listValue: pickImages);
    } catch (e) {
      log('error : $e');
    }
  }
